    ...
    <body>
        <div id="pagecontainer">
            ...
            <div id="content-children">
                <div id="content-children-title">${response.navChildren.childType} for ${response.navSelection}&nbsp;&nbsp;<a href="#">+ Add New Response</a></div>
                <div id="content-children-heading">Name</div>
                <g:each in="${response.navChildren.children}" var="child">
