...
<html>
    ...
    <body>
            <div id="content-detail">
                ...
                <div><a href="passwordReset">Reset password</a>&nbsp;&nbsp;&nbsp;&nbsp;<input id="rememberCheckbox" type="checkbox" name="remember" value="remember email address" /> remember email address</div>
