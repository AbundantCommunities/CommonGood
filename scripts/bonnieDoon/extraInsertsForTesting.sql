...
INSERT INTO person( id, version,  app_user,   birth_year,  date_created,  email_address,  family_id,  first_names,  last_name,  last_updated,  password_hash,  phone_number )
VALUES(  902,  0,  FALSE,  1902,  CURRENT_DATE,  'rr@abundantedmonton.ca',  NULL,  'Ryan',  'Radke',  CURRENT_DATE,  22333,  '444-555-6666' );

INSERT INTO person( id, version,  app_user,   birth_year,  date_created,  email_address,  family_id,  first_names,  last_name,  last_updated,  password_hash,  phone_number )
VALUES(  903,  0,  FALSE,  1902,  CURRENT_DATE,  'at@abundantedmonton.ca',  NULL,  'Angela',  'Taylor',  CURRENT_DATE,  44555,  '780-434-6071' );
